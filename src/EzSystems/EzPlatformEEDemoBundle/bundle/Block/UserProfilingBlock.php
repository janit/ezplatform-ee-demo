...
class UserProfilingBlock extends AbstractBlockType
{
    ...
    public function createBlockDefinition()
    {
        return new BlockDefinition(
            ...
            'User Profiling',
            'default',
            'bundles/ezplatformeedemo/images/userprofiling-block.svg',
            [],
            [
     ...
     * @param object $attributes
     *
     * @return \EzSystems\EzPlatformEEDemoBundle\Block\Model\TagItem[] $items
     */
     ...
     * @param \EzSystems\EzPlatformEEDemoBundle\Block\ItemCollection $itemCollection
     */
     ...
     *
     * @param \EzSystems\EzPlatformEEDemoBundle\Block\ItemCollection $input
     *
     * @return array
     */
